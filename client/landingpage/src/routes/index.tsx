...
const CLIENT_URL = (typeof process !== "undefined" && process.env?.["VITE_CLIENT_URL"]) || (import.meta as Record<string, any>)["env"]?.["VITE_CLIENT_URL"] || "http://localhost:5173";
const BUSINESS_URL = (typeof process !== "undefined" && process.env?.["VITE_BUSINESS_URL"]) || (import.meta as Record<string, any>)["env"]?.["VITE_BUSINESS_URL"] || "http://localhost:3000";
